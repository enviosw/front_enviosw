...
const Slider2: React.FC = () => {
    const slides = [
        {
            content: (
                <div className="relative w-full h-[40vh] lg:h-[55vh] bg-gradient-to-t from-primary/90 via-primary/70 to-primary/50 pt-10  lg:pt-12 flex items-end lg:items-center justify-between px-6 md:px-16 overflow-hidden">
                    {/* Imagen de fondo */}
